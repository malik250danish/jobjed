            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <!--main content-->
                        <form id="commentForm" action="{{ route('auth.store-company') }}"
                            ...
                            <div id="rootwizard">
                                <ul>
                                    <li><a href="#tab1" data-toggle="tab">Company Profile</a></li>
                        ...
                        <textarea name="bio" id="bio" class="form-control resize_vertical"
                                  rows="4">{!! old('bio') !!}</textarea>
                                    ...
                                    {{--  <div class="tab-pane" id="tab4" disabled="disabled">
                                        ...
                                        @endif
                                        <div class="form-group required">
                                            <label for="group" class="col-sm-2 control-label">7MIN Group *</label>
                                            <div class="col-sm-10">
                                                <select class="form-control required" title="Select group..." name="sevenmingroup"
                                                        id="sevenmingroup">
                                                    <option value="0">Select</option>
                                                    @foreach($sevenmingroup as $usergroup)
                                                        <option value="{{ $usergroup->id }}"
                                                                @if($usergroup->id == old('sevenmingroup')) selected="selected" @endif >{{ $usergroup->name}}</option>
                                                    @endforeach
                                                </select>
                                                {!! $errors->first('sevenmingroup', '<span class="help-block">:message</span>') !!}
                                            </div>
                                            <span class="help-block">{{ $errors->first('sevenmingroup', ':message') }}</span>
                                        </div>
                                        <div class="form-group">
