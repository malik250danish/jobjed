                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($result->cv_lock == 0)
                                    <a href="{{ url('cvconnect/'.$result->id) }}"
                                        onclick="return confirm('Are you sure you want to connect with this person')">
                                        <button class="btn  btn-primary">Connect</button>
                                    </a>
                                    @endif
                                    <a href="{{ url('admin/curriculamvitae/print/'.base64_encode($result->id)) }}"
                                        class="btn btn-info" target="_blank">
                                        Print
                                    </a>
                                    <a href="{{ url('admin/curriculamvitae/edit/'.base64_encode($result->id)) }}"
