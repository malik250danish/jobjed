                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ url('admin/login') }}" autocomplete="on" method="post" role="form" id="login_form">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/images/logo.png') }}" class="logo-img" alt="{{ env('APP_NAME') }} logo">
                                    <br>Admin Log In</h3>
                                    <!-- CSRF Token -->
                                    @csrf
                        ...
                        <div id="register" class="animate form">
                            <form action="{{ url('admin/signup') }}" autocomplete="on" method="post" role="form" id="register_here">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/images/logo.png') }}" class="logo-img" alt="{{ env('APP_NAME') }} logo">
                                    <br>Sign Up</h3>
                                    <!-- CSRF Token -->
                        ...
                        <div id="forgot" class="animate form">
                            <form action="{{ url('admin/forgot-password') }}" class="logo-img" autocomplete="on" method="post" role="form" id="reset_pw">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/images/logo.png') }}" alt="{{ env('APP_NAME') }} logo"><br>Forgot Password</h3>
                                <p>
