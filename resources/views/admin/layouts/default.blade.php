...
<header class="header">
    <a href="{{ url('admin') }}" class="logo">
        <img src="{{ asset('assets/images/logo.png') }}" style="height: 70px;" alt="logo">
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        @if(Auth::getUser()->pic)
                            <img src="{!! url('/').'/uploads/users/'.Auth::getUser()->pic !!}" alt="img" height="35px" width="35px"
                        ...
                        <div class="riot">
                            <div>
                                <p class="user_name_max">{{ Auth::getUser()->first_name }} {{ Auth::getUser()->last_name }}</p>
                                <span>
                                        <i class="caret"></i>
                                    </span>
                            </div>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header bg-light-blue">
                            @if(Auth::getUser()->pic)
                                <img src="{!! url('/').'/uploads/users/'.Auth::getUser()->pic !!}" alt="img"
                                     class="img-circle img-bor"/>
                            @else
                                <img src="{!! asset('assets/img/authors/avatar3.jpg') !!}"
                                     class="img-responsive img-circle" alt="User Image">
                            @endif
                            <p class="topprofiletext">{{ Auth::getUser()->first_name }} {{ Auth::getUser()->last_name }}</p>
                        </li>
                        <!-- Menu Body -->
                        <li>
                        ...
                        <li>
                            <a href="{{ url('admin/users/edit', Auth::getUser()->id) }}">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ url('lockscreen/'.Auth::getUser()->id) }}">
...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="left-side sidebar-offcanvas"><br>
            ...
            <div class="page-sidebar  sidebar-nav">
               <!--  <div class="nav_icons">
                ...
                @elseif(Auth::user()->role_id == 2)
                    @include('admin.layouts._left_menu_employeer')

                @elseif (Auth::user()->role_id == 4)
                @include('admin.layouts._left_menu_company')
                @endif
                <!-- END SIDEBAR MENU -->
            </div>
        </section>
