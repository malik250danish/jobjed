    ...
    <div class="row">
        ...
        <div class="box animation flipInX">
            ...
            <h3 class="text-primary">Log In</h3>
                ...
                <form action="{{ route('login.custom') }}" class="omb_loginForm"  autocomplete="off" method="POST">
                    ...
                    Don't have an account? <a href="{{ url('register') }}"><strong> Sign Up</strong></a>
        ...
        <div class="bg-light animation flipInX">
            ...
            <a href="{{ url('forgot-password') }}" id="forgot_pwd_title">Forgot Password?</a>
